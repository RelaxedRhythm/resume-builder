...
export function ProjectForm({ projectInfo, setProjectInfo }) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" name="description" value={formInfo.description} placeholder="Enter Project description" onChange={onHandleChange} />
            ...
            <input type="text" name="gitHubLink" value={formInfo.gitHubLink} placeholder="Enter Project gitHub" onChange={onHandleChange} />
            <label htmlFor="">Live Link</label>
            <input type="text" name="liveLink" value={formInfo.liveLink} placeholder="Enter Project link" onChange={onHandleChange} />
